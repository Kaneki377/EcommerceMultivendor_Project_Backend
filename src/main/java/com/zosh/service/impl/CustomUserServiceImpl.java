...
public class CustomUserServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if(username.startsWith(SELLER_PREFIX)){
            ...
            if(customer != null){
                return buildCustomerDetails(customer.getEmail(),customer.getPassword(),USER_ROLE.ROLE_CUSTOMER);
            }
        }
    ...
    private UserDetails buildCustomerDetails(String email, String password,USER_ROLE role) {
