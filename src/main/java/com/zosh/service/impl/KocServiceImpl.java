...
public class KocServiceImpl implements KocService {
    ...
    @Override
    public Koc createKoc(Long customerId, String socialLink) {
        // Tìm customer
        ...
        koc.setKocId("KOC" + UUID.randomUUID().toString().substring(0, 8)); // Sinh kocId duy nhất
        koc.setSocialLink(socialLink);
        ...
        account.setIsEnabled(true); // Kích hoạt tài khoản nếu cần
